#!/usr/bin/env python3
"""Transcript log writer + settings store + Together ASR proxy for Hearing Copilot. Thin wrapper:
the actual /log, /settings, and /asr handling lives in copilot_core.logserver.
...
ENV_PATH = os.environ.get("COPILOT_ENV_FILE") or os.path.join(APPDIR, "..", ".env")
